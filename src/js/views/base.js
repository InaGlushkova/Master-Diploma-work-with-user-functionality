export const elements = {
    ...
    userField: document.querySelector('.user__field'),
    userPage: document.querySelector('.user__page'),
    userMenu: document.querySelector('.user__menu'),
    userInfo: document.querySelector('.user__info'),
    userOrders: document.querySelector('.user__orders'),
    infoSection: document.querySelector('.user__info_section'),
    ordersSection: document.querySelector('.user__orders_section'),
    renderUserInfo: document.querySelector('.render__info'),
    noOrders: document.querySelector('.user__no_orders'),
    addUserInfo: document.querySelector('.attach_user_info'),
    addUserOrder: document.querySelector('.order__list'),
    userOrderTotal: document.querySelector('.attach_total')
};
